  ...
  template: `
    <aside class="w-64 bg-[#3A4750] border-r border-white/5 hidden md:flex flex-col h-full">
      ...
      <nav class="flex-1 px-4 py-4 space-y-2">
        ...
        <a routerLink="/tickets" routerLinkActive="active-link" class="nav-item flex items-center gap-3 px-4 py-3 rounded-lg transition-all duration-300 text-gray-400 hover:bg-white/5 hover:text-white border border-transparent">
